...
const Update = () => {
  ...
  const [type, setType] = useState("agriculterFarm");
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://localhost:5000/TwelveSection/agriculterFarm/update/${id}`, {
  ...
  const getSingle = async () => {
    try {
      const { data } = await axios.get(`http://localhost:5000/TwelveSection/agriculterFarm/${id}`);
      setName(data.name);
      ...
      <main>
        <form onSubmit={submitForm}>
          ...
          <div className="flex">
            ...
            <Link href="./finance/income/research-farm" className="btn btn-outline-secondary flex">
