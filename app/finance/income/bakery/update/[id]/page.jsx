...
const Update = () => {
  ...
  const submitForm = async (e) => {
    e.preventDefault();
    try {
      router.push("/finance/income/bakery");
      await axios.put(`http://localhost:5000/TwelveSection/bakery/update/${id}`, {
  ...
  const getSingle = async () => {
    try {
      const { data } = await axios.get(`http://localhost:5000/TwelveSection/bakery/${id}`);
      setName(data.name);
      ...
      <main>
        ...
        <section className="w-[95%] flex justify-between flex-wrap mx-auto my-3">
          ...
          <div className="flex">
            ...
            <Link href="./finance/income/bakery" className="btn btn-outline-secondary flex">
