...
const Update = () => {
  ...
  const [type, setType] = useState("kabulBank");
  ...
  const submitForm = async (e) => {
    e.preventDefault();
    try {
      router.push("/finance/income/kabul-bank");
      await axios.put(`http://localhost:5000/TwelveSection/kabul-bank/update/${id}`, {
  ...
  const getSingle = async () => {
    try {
      const { data } = await axios.get(`http://localhost:5000/TwelveSection/kabul-bank/${id}`);
      setName(data.name);
      ...
      <main>
        <form onSubmit={submitForm}>
          ...
          <div className="flex">
            ...
            <Link href="./finance/income/kabul-bank" className="btn btn-outline-secondary flex">
