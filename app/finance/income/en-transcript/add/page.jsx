...
const Add = () => {
  ...
  const submitForm = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:5000/EnTranscript", EnTranscript);
      router.push("/income/en-transcript");
    ...
    <>
      <header>
        <h3 className="my-4 text-center text-xl">
          فورم ثبت ترانسکریپت زبان انگلیسی
        </h3>
      </header>
      <hr />
      <main>
        <form onSubmit={submitForm}>
          ...
          <div className="flex">
            ...
            <Link href="./income/en-transcript" className="btn btn-outline-secondary flex">
